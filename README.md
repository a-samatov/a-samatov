...
### 🏗️ [Atamura Group — Единая цифровая платформа](https://github.com/a-samatov/atamura-platform-frontend)
Трёхкомпонентная система для казахстанского застройщика: SSR-портал на Nuxt 3, Vue 3 админ-панель и Go-бэкенд. 8 жилых комплексов, три языка, мгновенная индексация Google.
...
|----------|--------|------|
| Freelance / B2B Контрактор | Февраль 2026 — наст. время | Full-cycle Developer |
| QBiX | Май 2025 — Февраль 2026 | Fullstack-разработчик |
| НАО Университет Нархоз | Фев 2023 — Май 2025 | Fullstack-разработчик |
